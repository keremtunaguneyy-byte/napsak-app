...
3. İşine göre DESIGN_SPEC.md, ALGORITHM_SPEC.md veya FIREBASE_RUNBOOK.md.
...
Yeni tasarım sohbeti devam ederken kodlama hattı Ankara 101'in yerel dört commit'ini ana dalla karşılaştırıp doğrulama engelini çözsün. Görsel onay gerektirmeyen sonraki ürün işi, mekân detayını placeId üzerinden uygun N’apsak planlarına bağlamaktır. Kabul kriterleri STATUS'tadır.
