...
type ExperienceDraft = Omit<
  Experience,
  'kind' | 'lifecycle' | 'expiresAt' | 'points' | 'sources' | 'district' | 'latitude' | 'longitude' | 'lastVerifiedAt'
> & { pointIds: string[] };
...
export const experiences: Experience[] = [
  buildExperience({
    ...
    moods: ['Meraklı', 'Sakin'], interests: ['Sanat'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Sakin', 'Sosyal'], interests: ['Doğa', 'Lezzet'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Sakin', 'Sosyal'], interests: ['Kahve', 'Doğa'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sakin'], interests: ['Sanat'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Enerjik'], interests: ['Sanat', 'Doğa', 'Etkinlik'], groupSizes: [...allGroups],
    minDurationMinutes: 45, maxDurationMinutes: 60, priceLevel: 1,
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Enerjik'], interests: ['Sanat', 'Doğa'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Sakin', 'Enerjik'], interests: ['Doğa', 'Kahve'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sosyal'], interests: ['Sanat', 'Etkinlik'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sakin'], interests: ['Sanat', 'Kahve', 'Lezzet'], groupSizes: [...smallGroups],
    minDurationMinutes: 90, maxDurationMinutes: 120, priceLevel: 1,
  ...
  buildExperience({
    ...
    moods: ['Enerjik', 'Sakin'], interests: ['Doğa', 'Etkinlik'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Enerjik'], interests: ['Sanat'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sosyal'], interests: ['Sanat', 'Doğa', 'Kahve', 'Lezzet'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sakin'], interests: ['Sanat', 'Etkinlik'], groupSizes: [...smallGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sosyal'], interests: ['Sanat', 'Lezzet'], groupSizes: [...allGroups],
    minDurationMinutes: 180, maxDurationMinutes: 240, priceLevel: 2,
  ...
  buildExperience({
    ...
    moods: ['Sakin', 'Enerjik'], interests: ['Doğa'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Enerjik'], interests: ['Sanat', 'Doğa'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Sosyal'], interests: ['Lezzet', 'Sanat', 'Kahve'], groupSizes: [...allGroups],
  ...
  buildExperience({
    ...
    moods: ['Meraklı', 'Enerjik'], interests: ['Doğa', 'Sanat'], groupSizes: [...allGroups],
    minDurationMinutes: 300, maxDurationMinutes: 360, priceLevel: 1,
